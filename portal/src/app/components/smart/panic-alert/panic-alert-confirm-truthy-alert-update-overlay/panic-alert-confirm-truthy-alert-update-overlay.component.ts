...
@Component({
  selector: "app-panic-alert-confirm-truthy-alert-update-overlay",
  templateUrl: "panic-alert-confirm-truthy-alert-update-overlay.component.html",
  styleUrls: ["panic-alert-confirm-truthy-alert-update-overlay.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class PanicAlertConfirmTruthyUpdateCallOverlay implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<PanicAlertConfirmTruthyUpdateCallOverlay>,
  ...
  public confirm() {
    ...
    this.notificationsService
      .updatePanicAlertNotification(this.alert.id, true, this.attendanceEndedDateTime, this.data.newComment)
      .then(() => {
        this.onConfirm();
      })
      .finally(() => {
